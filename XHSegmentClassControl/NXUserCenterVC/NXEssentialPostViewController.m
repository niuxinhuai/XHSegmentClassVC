//
//  NXEssentialPostViewController.m
//  firstproject
//
...
#import "NXEssentialPostViewController.h"

@interface NXEssentialPostViewController ()<UITableViewDataSource, UITableViewDelegate>
@property (nonatomic, strong) UITableView * classTableView;
@end

@implementation NXEssentialPostViewController
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.textLabel.text = [NSString stringWithFormat:@"我是第 %ld 个单元格",indexPath.row+100];
    return cell;
}
//cell 高度
