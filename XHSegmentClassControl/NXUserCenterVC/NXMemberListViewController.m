...
#import "NXMemberListViewController.h"

@interface NXMemberListViewController ()<UITableViewDelegate, UITableViewDataSource>
@property (nonatomic, strong) UITableView * classTableView;
@end

@implementation NXMemberListViewController
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.textLabel.text = [NSString stringWithFormat:@"我是第 %ld 个单元格",indexPath.row+10];
    return cell;
}
//cell 高度
